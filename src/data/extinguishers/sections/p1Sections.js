/**
 * TZ P1 – servisne upute (PDF KLALEDA str. 101–102; naslov poglavlja SERVISNE UPUTE − TZ P1).
 */
export const SECTIONS_P1 = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        note:
          'NAPOMENA: Obzirom da pravilnik o vatrogasnm aparatima zahtijeva da se naljepi naljepnica na usponsku cijev, potrebno je odraditi slijedeće radnje: Otvoriti spremnik, zalijepiti naljepnicu na usponsku cijev, zamijeniti O-brtvu ventila, te zavrnuti ventil. Sve navedeno je opisano u točkama 2.2.1., 2.4., 2.5.2 – 2.5.9.',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '2.5.6. Posušiti i očistiti vatrogasni aparat. Oprez: U ventilu ne smiju biti ostaci brtvenog materijala.',
          '2.5.7. Montirati zaštitnu kapu ventila i plombirati tlačnu polugu pomoću zatika osigurača.',
          '2.5.8. Staviti potvrdu o servisiranju ispod ili s desne strane natpisa. Ne smije se stavljati naljepnica preko polja za natpis, pa čak ni djelomično. Treba navesti datum ispitivanja i unutarnjeg pregleda (mjesec/godina) kao i broj ili ime ispitanika i adresa.',
